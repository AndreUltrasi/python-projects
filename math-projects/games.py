...
def matemaniaco():
    print("\nOlá {}, este é o jogo Matemaníaco dê o resultado correto para ganhar moedas".format(personagem))
    matemaniacoQuestoes(aleatorio(0, 3))
    menuJogos()
...
def binQuest():
    try:
        print("\nOlá {}, este é o jogo BinQuest, dê o resultado correto para ganhar moedas".format(personagem))
        binarioQuestoes(aleatorio(0, 1))
        menuJogos()
    except:
...
def funcaoVelha():
    ...
    global list
    velhaDesenho()
    posicao = int(input("Escolha um número: "))
    if posicao == 1:
      if list[0] == "X" or list[0] == "O":
        print ("Ops, posição já preenchida, escolha outra !")
        funcaoVelha()
      else:
        list[0]="X"
    elif posicao == 2:
    ...
    if velhaPossibilidades("X") == True:
      ...
      moedas += 10
      menuJogos()
    if velhaPossibilidades("velha") == True:
      velhaDesenho()
      print ("Deu velha !")
      menuJogos()
    z=aleatorio(0,8)
...
def jogoDaVelha():
  global list
  print("\nOlá {}, este é o Jogo da Velha, tente ganhar de mim :D".format(personagem))
...
def begin():
  ...
  print ("Responda corretamente às perguntas para ganhar moedas\n")
